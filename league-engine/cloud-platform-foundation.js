(() => {
  ...
  function renderPanel() {
    ...
    return `<article class="card league-import-framework-card" data-cloud-platform-panel>
      <div class="card-header"><div><span class="eyebrow">v5.9.3.0a · Storage foundation</span><h3>Cloud Platform Foundation</h3><p>D1, R2, KV, and secret readiness for the multi-league backend.</p></div>${pill(tone, stateLabel)}</div>
