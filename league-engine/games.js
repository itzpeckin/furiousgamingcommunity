(function initGamesService(global){
  ...
  function diagnostics(){const c=config();return freeze({service:'games',version:'5.6.1',season:c.season,poolStatus:c.status,gameCount:allGames().length,currentWeek:currentWeek(),entryCount:Object.keys(c.entries).length,ownerRatingBaseline:BASELINE,ownerRankingCount:ownerHistory().length})}
