(() => {
  ...
  if (!HQ?.defineService || !HQ.leagueSchema) throw new Error('league-engine/schema.js must load before migrations.js.');
  ...
  const service = HQ.defineService('leagueMigrations', { register, migrate, list: () => Object.freeze([...migrations.keys()]) });
  HQ.manifest?.register?.({ id: 'league-migrations', service: 'leagueMigrations', script: 'league-engine/migrations.js', version: '1.0.0', dependencies: ['leagueSchema'], capabilities: ['schema-evolution', 'explicit-migrations'] });
})();
