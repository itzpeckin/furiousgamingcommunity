(() => {
  ...
  function renderPanel() {
    ...
    return `<section data-live-read-model-panel>
      <article class="card">
        <div class="card-header"><div><span class="eyebrow">v5.9.4.1 · Live Snapshot Read Model</span><h3>Live Read Model</h3><p>Stable application-facing contracts backed only by the league's active immutable snapshot.</p></div><span class="pill pill--${state==='LIVE'?'success':'neutral'}">${esc(state)}</span></div>
