...
1. Confirm Trade Center → History includes search, status, team, asset, trade-type, season, date, and sort filters.
2. Search by player, pick, team, owner, and trade number.
3. Open a Team page → Trade History and open an approved trade.
