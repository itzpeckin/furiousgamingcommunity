# v5.9.0.3 Validation Guide

## 1. Confirm the release
Hard refresh the site. The bottom-left footer must display `v5.9.0.3 · Validation Engine`.
...
```
Expected: version `5.9.0.3`, validatorCount `9`, automaticCandidateRejection `true`, warningSupport `true`.
