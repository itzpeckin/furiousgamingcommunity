...
| 7.4.0.7 | Local candidate | Reusable Madden 27 opening pick source, private FGC ownership overlay, commissioner-only preview/apply contract, and automatic three-class season rollover |
