...
**Current production:** 7.4.0.6 is active from exact Main merge `d138e1a`; the authenticated protected-route release marker was verified on September 4, 2026. Migration 30 is the current Production database boundary. No migration, league-data operation, or league-specific draft-pick baseline ran. Blocked Madden Free Agents remain unknown/null and are not interpreted as zero.

**Current work:** 7.4.0.6 is deployed and awaiting signed-in owner UI acceptance. It adds proposer revision of sent negotiating offers, premium opened-proposal asset rows, preserved multi-team selection position, direct owned-listing removal, exact-player notes focus, and consolidated mobile Trade Center/Trade Block remediation.

**Next gate:** Complete signed-in owner acceptance of 7.4.0.6 across desktop and phone. No migration or data operation is required. Do not seed picks, import, reset, delete, archive, rotate, transition, change the active snapshot, or reinterpret blocked Free Agents as zero.
