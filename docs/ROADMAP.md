...
**Current work:** 7.3.4.6 is released and owner-accepted. Its exact-once retained-source workflow composed Preseason Weeks 1–3 and Regular Season Weeks 1–8 behind the preserved live Week 9 plane; the active snapshot now exposes 184 games and 6,966 statistic records across every data-bearing period, while Madden's all-zero Preseason Week 4 placeholder remains excluded.
