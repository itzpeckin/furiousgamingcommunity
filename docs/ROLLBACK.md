...
The accepted candidate started from Week 9 snapshot `518236e4-1cac-41f5-b8c8-757b7150dcd8` and atomically activated snapshot `b00edb25-ac65-40d4-9969-431f94dd1e3e`. It overlaid route-scoped games/statistics for retained earlier periods only. Teams, 2,042 active rostered players, rosters, standings, Madden game year, franchise season, and the live Week 9 position remained byte-for-byte authoritative from the prior snapshot.

Production Pages deployment `dca6eb7d-9e6d-4678-ab7c-a5194429373c` and Worker build `845c2a0b-6e1a-4c03-8275-22a49a391a14` / version `e7d81630-5d93-4726-a0c2-f71e8c12e96a` run exact Main commit `4c9d75a8ec09caa2bc50ae888fd6b2af255f58b3`. Runtime rollback restores exact 7.3.4.5 Main commit `df3bcb7cd927f21acd3362d62a722d582f485884`, Pages deployment `927eb46c-1e53-4f72-a0b6-698c2a351861`, and Worker version `87b5571a-8aff-49f9-853a-d0749d968d6f`. Retain active snapshot `b00edb25`, previous snapshot `518236e4`, and all 7.3.4.6 raw captures, reports, mapping runs, candidates, lifecycle events, and audit rows. Code rollback does not imply snapshot rollback.
