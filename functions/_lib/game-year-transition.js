...
export const GAME_YEAR_TRANSITION_RELEASE = '7.6.0-rc.1';
...
export const PERSISTENT_PLATFORM_TABLES = Object.freeze([
  ...
  'commissioner_roster_movements',
  'gm_identities',
  'team_ownership_periods',
  'gm_season_summaries',
  'franchise_seasons',
  'franchise_season_closures',
  'league_draft_pick_baselines',
  'league_draft_pick_baseline_entries',
  'league_draft_pick_baseline_applications'
]);
