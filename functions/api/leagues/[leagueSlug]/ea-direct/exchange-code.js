...
export async function onRequestPost({request,env,params}){
  ...
  // 6.0.4a deliberately does not persist or return token values.
  return json({
    ...
    next:summary.accessTokenPresent
      ? '6.0.4a validated. Next build can use the server-side token in the same request flow for Madden persona/session discovery.'
