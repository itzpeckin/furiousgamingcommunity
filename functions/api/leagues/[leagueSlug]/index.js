...
export async function onRequestGet(context){
  ...
  if(!validLeagueSlug(slug))return json({ok:false,release:'6.1.0',error:'Invalid league slug.'},400);
  ...
  if(!league)return json({ok:false,release:'6.1.0',error:'League not found.',leagueSlug:slug},404);
  ...
  return json({ok:true,release:'6.1.0',tenant:{
