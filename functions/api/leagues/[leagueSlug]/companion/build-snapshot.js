...
try{
 ...
 if(rosterCarryForward){
   warnings.push(`Players, contracts, roster assignments, and Free Agent state were carried forward from active snapshot ${activeSource.id}.`);
